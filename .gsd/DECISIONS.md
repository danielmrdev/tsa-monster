...
| D010 | M001/S02/T02 | design | Home page section count and editorial trust signals | Four sections: hero, category grid, recent articles (empty-safe), trust bar — rather than the three planned | A trust bar (no free samples, no paid placement, no AI-generated ratings) adds credibility content that matters for Amazon Associates review and organic user trust. Zero complexity cost — it's a static HTML section with no new components or data dependencies. | Yes |
